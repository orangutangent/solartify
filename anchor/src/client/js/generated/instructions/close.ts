...
export type CloseInput<
  ...
  TAccountNftgifter extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountNftgifter>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountNftgifter> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.nftgifter),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountNftgifter>;
